 ...
 *
 * <p>Specifically, {@code @NettyHttpPost} is a composed annotation that
 * acts as a shortcut for {@code @NettyHttpMapping(method = "POST")}.
 *
...
@Documented
@NettyHttpMapping(method = "POST")
public @interface NettyHttpPost {

    /**
     * The path mapping URIs (e.g. {@code "/order"}).
