...
/**
 * Annotation for handling WebSocket text frame messages.
 *
 * <p>Methods annotated with this annotation are invoked when a text frame
...
@Documented
public @interface NettyWsOnText {
