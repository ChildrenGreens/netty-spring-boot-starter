 ...
 *
 * <p>Specifically, {@code @NettyHttpPut} is a composed annotation that
 * acts as a shortcut for {@code @NettyHttpMapping(method = "PUT")}.
 *
...
@Documented
@NettyHttpMapping(method = "PUT")
public @interface NettyHttpPut {
