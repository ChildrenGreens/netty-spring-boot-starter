...
public class ChatWebSocketHandler {
    ...
    @NettyWsOnError("/chat/{roomId}")
    public void onError(Throwable error, NettyContext context) {
        log.error("WebSocket error for channel {}", context.getChannelId(), error);
    }
}
----
